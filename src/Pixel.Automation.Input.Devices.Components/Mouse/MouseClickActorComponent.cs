            ...
            case MouseButton.LeftButton:
                switch (this.ClickMode)
                {
                    case ClickMode.SingleClick:
                        ...
                        logger.Information("Left click was performed at {0}", screenCoordinate);
                        break;
                    case ClickMode.DoubleClick:
                        syntheticMouse.DoubleClick(MouseButton.LeftButton);
                        logger.Information("Left double click was performed at {0}", screenCoordinate);
                        break;
                }
                break;
            case MouseButton.MiddleButton:
                switch (this.ClickMode)
                {
                    case ClickMode.SingleClick:
                        ...
                        logger.Information("Middle click was performed at {0}", screenCoordinate);
                        break;
                    case ClickMode.DoubleClick:
                        syntheticMouse.DoubleClick(MouseButton.MiddleButton);
                        logger.Information("Middle double click was performed at {0}", screenCoordinate);
                        break;
                }
                break;
            case MouseButton.RightButton:
                switch (this.ClickMode)
                {
                    case ClickMode.SingleClick:
                        ...
                        logger.Information("Right click was performed at {0}", screenCoordinate);
                        break;
                    case ClickMode.DoubleClick:
                        syntheticMouse.DoubleClick(MouseButton.RightButton);
                        logger.Information("Right double click was performed at {0}", screenCoordinate);
                        break;
                }
                break;
        }
