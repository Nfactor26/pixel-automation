...
public abstract class UIAControlScrapper : PropertyChangedBase, IControlScrapper, IHandle<RepositoryApplicationOpenedEventArgs>
{
    ...
    public UIAControlScrapper(IEventAggregator eventAggregator, IHighlightRectangleFactory highlightRectangleFactory, IScreenCapture screenCapture)
    {
    ...
    protected abstract AutomationElement GetTrackedElement();
    ...
    private void CaptureTimer_Tick(object sender, EventArgs e)
    {
        ...
        Thread captureControlThread = new Thread(() =>
        {
            try
            {              
                AutomationElement trackedElement = GetTrackedElement();
