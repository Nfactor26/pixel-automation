...
using Glyph = Pixel.Scripting.Editor.Core.Glyph;
...
namespace Pixel.Scripting.Editor.Services.CSharp
{
    public static class CodeActionExtensions
    {
        ...
        {
            if (completionItem == null) throw new ArgumentNullException(nameof(completionItem));

            return GetGlyph(completionItem.Tags);
        }
