...
namespace Pixel.UIAComWrapperInternal
{
    /// <summary>
    ...
    internal static class UiaCoreProviderApi
    {
        ...
        private static extern int RawUiaRaiseAsyncContentLoadedEvent(IRawElementProviderSimple provider, Pixel.Windows.Automation.AsyncContentLoadedState asyncContentLoadedState, double PercentComplete);
        ...
        [SecuritySafeCritical, SecurityCritical]
        internal static void UiaRaiseAsyncContentLoadedEvent(IRawElementProviderSimple provider, Pixel.Windows.Automation.AsyncContentLoadedState asyncContentLoadedState, double PercentComplete)
        {
