...
using StructureChangeType = Pixel.Windows.Automation.StructureChangeType;
...
internal class StructureEventListener : EventListener, UIAutomationClient.IUIAutomationStructureChangedEventHandler
{
    ...
    public void HandleStructureChangedEvent(UIAutomationClient.IUIAutomationElement sender, UIAutomationClient.StructureChangeType changeType, int[] runtimeId)
    {
