...
[DataContract]
[Serializable]
[ToolBoxItem("Switch To Window", "Appium", "Browser", iconSource: null, description: "Switch to desired window using its index", tags: new string[] { "switch", "window" })]
public class SwitchToWindowActorComponent : AppiumElementActorComponent
{
    ...
    {
        IWebDriver webDriver = ApplicationDetails.Driver;
