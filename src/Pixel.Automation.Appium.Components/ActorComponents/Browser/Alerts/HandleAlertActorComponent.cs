...
[DataContract]
[Serializable]
[ToolBoxItem("Handle Alert", "Appium", "Alerts", iconSource: null, description: "Accept/Dissmiss alert on web page", tags: new string[] { "alert"})]
public class HandleAlertActorComponent : AppiumElementActorComponent
{
