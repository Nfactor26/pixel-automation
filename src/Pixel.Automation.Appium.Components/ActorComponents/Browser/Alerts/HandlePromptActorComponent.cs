...
[DataContract]
[Serializable]
[ToolBoxItem("Handle Prompt", "Appium", "Alerts", iconSource: null, description: "Interact with browser prompot window", tags: new string[] { "prompt" })]
public class HandlePromptActorComponent : AppiumElementActorComponent
{
    ...
    {
        IAlert alert = ApplicationDetails.Driver.SwitchTo().Alert();
        switch (this.Action)
        {
