...
[DataContract]
[Serializable]
[ToolBoxItem("Close Window", "Appium", "Browser", iconSource: null, description: "Close a tab or window", tags: new string[] { "close", "tab" , "window" })]
public class CloseWindowActorComponent : AppiumElementActorComponent
{
