...
{
    private readonly ILogger logger = Log.ForContext<FindWindowFromHandleActorComponent>();
    ...
    public override async Task ActAsync()
    {
        ...
        logger.Information("Window with title : '{0}' was located for hWnd : '{1}'", foundWindow.WindowTitle, windowHandle);
