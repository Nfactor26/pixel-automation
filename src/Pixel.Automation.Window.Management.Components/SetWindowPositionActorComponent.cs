...
{
    private readonly ILogger logger = Log.ForContext<SetWindowPositionActorComponent>();
    ...
    public override async Task ActAsync()
    {
        ...
        logger.Information("Window with title : '{0}' and hWnd : '{1}' was moved to '{2}' ", targetWindow.WindowTitle, targetWindow.HWnd, newPosition);
